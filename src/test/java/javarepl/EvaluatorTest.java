...
public class EvaluatorTest {
  ...
  public void supportsRedefiningAndOverloadingMethods() {
    ...
    assertThat(evaluating("int method(){return 21;}", "int method(int i){return i;}", "method() + method(21)"),
            hasResult(42));
  }
  ...
  public void shouldReturnTypeOfExpression() {
    ...
    assertThat(new Evaluator().typeOfExpression("System.out.println(\"hello\")"),
            is(none(java.lang.reflect.Type.class)));
  }
  ...
  private static Matcher<Either<? extends Throwable, Evaluation>> hasNoResult() {
    return new FeatureMatcher<Either<? extends Throwable, Evaluation>, Object>(Matchers.<Object>is(Result.noResult()),
  ...
  private static Matcher<Either<? extends Throwable, Evaluation>> hasCompilationError() {
    return new FeatureMatcher<Either<? extends Throwable, Evaluation>, Object>(
            Matchers.<Object>is(instanceOf(ExpressionCompilationException.class)), "result value", "result value") {
  ...
  private static Matcher<Either<? extends Throwable, Evaluation>> hasExpressionOfType(Class<?> clazz) {
    return new FeatureMatcher<Either<? extends Throwable, Evaluation>, Expression>(instanceOf(clazz), "result value",
            "result value") {
